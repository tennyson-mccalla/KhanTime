...
// Verify the Khan Academy course exists and has content
...
// Main execution
do {
    print("🔍 Verifying Khan Academy course: \(khanCourseId)")
    ...
    if syllabusHttpResponse.statusCode == 200 {
        ...
        if let components = syllabus["subComponents"] as? [[String: Any]] {
            ...
            for (index, component) in components.enumerated() {
                ...
                if let resources = component["resources"] as? [[String: Any]] {
    ...
    print("📱 UserDefaults should be: defaults write com.Tennyson.KhanTime KhanAcademyCourseId '\(khanCourseId)'")
